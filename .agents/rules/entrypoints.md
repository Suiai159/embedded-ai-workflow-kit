...
| `CLAUDE.md` | Claude Code compatibility entrypoint |
...
| `.claude/skills/` | Claude/Codex compatibility mirror |

## Rules

- Keep root entrypoints as compatibility shims and high-signal summaries.
...
- Do not make `.claude/` the canonical home for project rules or Skills.
